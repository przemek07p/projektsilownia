...
namespace projekt003.Models
{
    public class Meal
    {
        ...
        //{
        //    get { return this.GetType().GetProperty(index).GetValue(this).ToString(); }
        //    set { this[index] = value; }
        //}
        public string this[string propertyName]
        {
            get { PropertyInfo property = GetType().GetProperty(propertyName); return property.GetValue(this, null).ToString(); }
            set { PropertyInfo property = GetType().GetProperty(propertyName); property.SetValue(this, value); }
        }
